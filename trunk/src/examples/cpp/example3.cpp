...
set_cord1_change(0.0, 0.0, -2.0);
set_cord2_change(-1.0, 0.0, 0.0);
set_cord3_change(0.0, 0.0, -1.0);
set_mat_cord_change(0.0, 0.5, 0.0);
set_color1_change(0.0, 0.0, -1.0, 0.0);
set_color2_change(0.0, 1.0, 0.0, 0.0);
set_color3_change(1.0, 0.0, 0.0, 0.0);
